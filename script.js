    ...
    projects: [
        {
            ...
            description: "Современный жилой комплекс с развитой инфраструктурой и панорамными видами.",
            location: "г.Симферополь, мкр. 'Жигулина Роща', ул. Крымской Весны 1",
            area: "100 м²",
            images: [
        ...
        },
        {
            ...
            description: "Роскошный загородный дом с ландшафтным дизайном и бассейном.",
            location: "Подмосковье, п. Заречье",
            area: "450 м²",
            images: [
                "https://images.unsplash.com/photo-1575517111839-3a3843ee7f5d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                "https://images.unsplash.com/photo-1497366754035-f200968a6e72?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        ...
        {
            title: "Квартира в 'Город мира'",
            description: "Уютная квартира в экологичном комплексе с зеленой зоной.",
            location: "г.Симферополь, ул. Батурина 15",
            area: "90 м²",
            images: [
                "https://images.unsplash.com/photo-1497366754035-f200968a6e72?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                "https://images.unsplash.com/photo-1501182563531-c2b4e735a73e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        ...
        },
        {
            ...
            description: "Современный офис с панорамными окнами и парковкой.",
        ...
        {
            title: "Торговый центр 'Северный'",
            description: "Крупный торговый комплекс с кинотеатром и ресторанами.",
            location: "г.Санкт-Петербург, пр. Просвещения 25",
            area: "5000 м²",
            images: [
                "https://images.unsplash.com/photo-1575517111839-3a3843ee7f5d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                "https://images.unsplash.com/photo-1501182563531-c2b4e735a73e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        ...
        {
            title: "Дача 'Лесная поляна'",
            description: "Уютная дача с сауной и террасой в хвойном лесу.",
            location: "Ленинградская обл., д. Сосновка",
            area: "150 м²",
            images: [
                "https://images.unsplash.com/photo-1497366754035-f200968a6e72?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                "https://images.unsplash.com/photo-1575517111839-3a3843ee7f5d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        ...
        {
            title: "Жилой комплекс 'Радуга'",
            description: "Многоэтажный дом с детскими площадками и паркингом.",
            location: "г.Краснодар, ул. Солнечная 7",
            area: "2000 м²",
            images: [
                "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                "https://images.unsplash.com/photo-1497366754035-f200968a6e72?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        ...
        },
        {
            ...
            description: "Современный склад с автоматизированными системами.",
            location: "г.Новосибирск, промзона Север",
            area: "3000 м²",
            images: [
                "https://images.unsplash.com/photo-1501182563531-c2b4e735a73e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        ...
        {
            title: "Коттедж 'Озерный'",
            description: "Экологичный коттедж с видом на озеро и камином.",
            location: "Калужская обл., д. Озерки",
            area: "300 м²",
            images: [
                "https://images.unsplash.com/photo-1575517111839-3a3843ee7f5d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                "https://images.unsplash.com/photo-1501182563531-c2b4e735a73e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        ...
        {
            title: "Многоэтажка 'Центральная'",
            description: "Жилой дом в центре города с лифтами и паркингом.",
            location: "г.Екатеринбург, ул. Центральная 12",
            area: "1500 м²",
            images: [
                "https://images.unsplash.com/photo-1497366754035-f200968a6e72?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                "https://images.unsplash.com/photo-1575517111839-3a3843ee7f5d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Инициализация внешнего Swiper для проектов
    new Swiper('.projects-swiper', {
        slidesPerView: 1,
        spaceBetween: 15,
        loop: true,
        pagination: {
            el: '.projects-swiper .projects-pagination',
            clickable: true,
        },
        navigation: {
    ...
    document.querySelectorAll('.project-img-swiper').forEach(swiper => {
        new Swiper(swiper, {
            ...
            loop: true,
            pagination: {
                el: swiper.querySelector('.img-pagination'),
                clickable: true,
            },
            navigation: {
...
function validateForm() {
    ...
    // Валидация имени
    if (!name.value.match(/^[А-Яа-яЁёA-Za-z\s-]{2,}$/)) {
        document.getElementById('name-error').textContent = 'Имя должно содержать только буквы, дефисы и пробелы (мин. 2 символа)';
